...
namespace Leguar.TotalJSON.Examples {
	...
	public partial class SaveAndLoadFile : Node {

		// Note: Since this is just an example, file is saved to TotalJSON Examples folder!
		// (Normally files should be saved to for example "user://" path, depending on platform and what data is saved)
		private const string FILE_PATH = "TotalJSON/Examples/Test_SaveFile.json";
