...
namespace Leguar.TotalJSON {
	...
	public class DeserializeSettings {
		...
		private bool ignoreSystemAndGodotSerializeAttributes = false;

		/// <summary>
		/// By default this is false. Meaning that deserialization will check fields for Godot.Export and System.NonSerialized attributes and follow those.
		/// 
		...
		/// </value>
		public bool IgnoreSystemAndGodotSerializeAttributes {
			set {
				ignoreSystemAndGodotSerializeAttributes = value;
			}
			get {
				return ignoreSystemAndGodotSerializeAttributes;
			}
		}
